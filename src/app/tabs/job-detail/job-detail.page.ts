...
import { IonBackButton, IonButton, IonButtons, IonChip, IonCol, IonContent, IonFooter, IonHeader, IonIcon, IonItem, IonLabel, IonList, IonRow, IonSegment, IonSegmentButton, IonText, IonThumbnail, IonToolbar } from '@ionic/angular/standalone';
