...
import { IonButton, IonButtons, IonCol, IonContent, IonHeader, IonIcon, IonLabel, IonList, IonListHeader, IonRow, IonSearchbar, IonText, IonThumbnail, IonTitle, IonToolbar } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, IonThumbnail, IonButtons, IonIcon, IonRow, IonCol, IonLabel, IonText, IonSearchbar, IonButton, IonList, IonListHeader, JobComponent, RouterModule],
